    ...
    extends DimensionalInventoriesGameTest
{
    ...
    public void transitionSwapsXpStorageTrinkets( final TestContext context )
    {
        ...
        final ItemStack xpConduit1 = new ItemStack( ItemRegistry.XP_CONDUIT, 1 );
        final ItemStack xpConduit2 = new ItemStack( ItemRegistry.XP_CONDUIT, 1 );

        // XP Savers can only be placed in the necklace slot. Create one for that
        final ItemStack xpSaver = new ItemStack( ItemRegistry.XP_SAVER, 1 );
        ...
        handSlot.assertItemType( ItemRegistry.XP_CONDUIT );
        handSlot.assertCount( 1 );
        offHandSlot.assertItemType( ItemRegistry.XP_CONDUIT );
        offHandSlot.assertCount( 1 );
        necklaceSlot.assertItemType( ItemRegistry.XP_SAVER );
